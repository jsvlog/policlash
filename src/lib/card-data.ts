...
export const SHOP_PACKS: ShopPack[] = [
  {
    ...
    description: 'For the serious collector. 3 cards, guaranteed Epic or higher. ~10% mythic chance per card!',
    price: 100,
    card_count: 3,
  ...
  },
  {
    id: 'budget-pack',
    name: 'Budget Pack',
    description: 'Great for beginners. 3 cards, guaranteed Common or higher. No mythic — gotta start somewhere! New accounts get one free!',
    price: 25,
    card_count: 3,
