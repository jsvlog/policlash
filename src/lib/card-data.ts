...
export const STARTER_CARDS: GameCard[] = [
  ...
  // ---- Mythic Tier: National Figures ----
  {
    ...
    faction: 'dynasty',
    rarity: 'mythic',
    stats: { charisma: 8, machinery: 10, budget: 10, influence: 9 },
    ability: ab('unity', 'Bagong Pilipinas', 'rally_support', '+4 Charisma and +2 Influence to all allies on board.', 6, 3),
    art_url: '',
    flavor_text: 'Unity is the name of the game.',
    cost: 10,
    pack_source: 'elite-pack',
  },
  {
    id: 'mythic-sara',
    name: 'Sara Duterte',
    ...
    faction: 'dynasty',
    rarity: 'mythic',
    stats: { charisma: 7, machinery: 9, budget: 9, influence: 8 },
    ability: ab('confidential', 'Confidential Funds', 'blackmail', 'Destroy the enemy card with the lowest Influence. Costs no Budget this turn.', 2, 4),
    art_url: '',
    flavor_text: 'Res ipsa loquitur.',
    cost: 9,
    pack_source: 'elite-pack',
  },
  {
    ...
    faction: 'reformer',
    rarity: 'mythic',
    stats: { charisma: 10, machinery: 5, budget: 6, influence: 8 },
    ability: ab('angat_buhay', 'Angat Buhay', 'pardon', 'Revive all destroyed allies from graveyard with +2 Charisma.', 3, 5),
    art_url: '',
    flavor_text: 'The people\'s campaign never ends.',
    cost: 9,
    pack_source: 'elite-pack',
  },
]

// ---- Premium Packs (3-pack system with tiered mythic odds) ----
// Mythic odds per card: Elite ~10% | Standard ~5% | Budget 0%
// Weights are proportional: weight / total = % chance per card roll
export const SHOP_PACKS: ShopPack[] = [
  {
    id: 'elite-power-pack',
    name: 'Elite Power Pack',
    description: 'For the serious collector. 5 cards, guaranteed Epic or higher. ~10% mythic chance per card!',
    price: 100,
    card_count: 5,
    guaranteed_rarity: 'epic',
    rarity_weights: { common: 5, rare: 10, epic: 30, legendary: 25, mythic: 10 },
    art_url: '',
    featured_cards: ['Bongbong Marcos', 'Sara Duterte', 'Leni Robredo'],
  },
  {
    id: 'standard-pack',
    name: 'Standard Pack',
    description: 'Your go-to pack. 5 cards, guaranteed Rare or higher. ~5% mythic chance per card.',
    price: 50,
    card_count: 5,
  ...
  },
  {
    id: 'budget-pack',
    name: 'Budget Pack',
    description: 'Great for beginners. 5 cards, guaranteed Common or higher. No mythic cards here — gotta start somewhere!',
    price: 25,
    card_count: 5,
    guaranteed_rarity: 'common',
    rarity_weights: { common: 50, rare: 30, epic: 15, legendary: 5, mythic: 0 },
    art_url: '',
    featured_cards: ['Mayor Budots', 'Barangay Captain Trapo'],
  },
]
